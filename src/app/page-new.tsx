      ...
      <div className="container mx-auto px-4 py-16">
        <div className="text-center max-w-4xl mx-auto">
          ...
          <p className="text-xl text-gray-600 mb-8">
            ...
            Join our community of mindful practitioners on a journey of wellness and self-discovery.
          </p>
          ...
          <div className="grid md:grid-cols-3 gap-8 mt-12">
            <div className="bg-white rounded-lg p-6 shadow-lg">
              ...
              <p className="text-gray-600">Access hundreds of yoga classes anytime, anywhere</p>
            </div>
            
            <div className="bg-white rounded-lg p-6 shadow-lg">
              <div className="text-3xl mb-4">📅</div>
              <h3 className="text-xl font-semibold mb-2">Live Classes</h3>
              <p className="text-gray-600">Join live sessions with certified instructors</p>
            </div>
            
            <div className="bg-white rounded-lg p-6 shadow-lg">
              <div className="text-3xl mb-4">💫</div>
              <h3 className="text-xl font-semibold mb-2">Personalized Journey</h3>
              <p className="text-gray-600">Customized recommendations for your practice</p>
            </div>
          </div>
